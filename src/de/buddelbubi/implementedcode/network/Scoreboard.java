...
import de.buddelbubi.implementedcode.network.packet.RemoveObjectivePacket;
import de.buddelbubi.implementedcode.network.packet.SetObjectivePacket;
import de.buddelbubi.implementedcode.network.packet.SetScorePacket;
...
public class Scoreboard {
    ...
    private DataPacket constructDisplayPacket( DisplaySlot slot, ScoreboardDisplay display ) {
        ...
        packetSetObjective.setCriteriaName( "dumy" );
    ...
    private class ScoreboardLine {
		...
		public ScoreboardLine(byte b, long id, String string, String objective2, int score2) {
			type = b;
			entityId = id;
			fakeName= string;
